    ...
    >
      ...
      >
        <Container fluid className="text-white text-center py-5">
          ...
          {user && (
            <div
              className="alert alert-light d-inline-block"
              style={{ border: "none" }}
            >
          ...
          <Row className="justify-content-center my-5">
            <Col lg={8}>
              ...
              <p className="fs-5">
                This platform tracks and analyzes femicide cases across Kenya to
                provide data-driven insights for policymakers, researchers, and
                activists working to end gender-based violence.
              </p>
            </Col>
          </Row>
            ...
            {[
              {
                ...
                description:
                  "Systematic recording of femicide cases nationwide with verified sources",
              },
              {
                icon: "bi-graph-up",
                title: "Analysis",
                description:
                  "Advanced trend analysis and visualization tools for identifying patterns",
              },
              {
                icon: "bi-file-earmark-text",
                title: "Reporting",
                description:
                  "Generate comprehensive reports for advocacy and policy development",
              },
            ].map((feature, index) => (
              <Col md={4} key={index}>
                <Card
